...
# 1.
arr2_bs_artTags = []
for item in arr1_pageIdxUrl :
    arr2_bs_artTags.append(bs(requests.get(item, 'html.parser')))
...
'''
2. article 방문, html 가져오기
'''
    # article방문, page html 가져오기
