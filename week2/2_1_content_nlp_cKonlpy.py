...
# 형태소 분석 테스트
test_series1 = df['art_content'].map(lambda title : postprocessor.pos(title))
...
for i in range(len(test_series1)):
    ...
    arr_noun_content.append(temp)


print(arr_noun_content)

import numpy as np
np.save('./week2/arr2_noun_content',arr_noun_content)
