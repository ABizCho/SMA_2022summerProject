...
ㅇㅇuniversity e-Business ㅇㅇ 교수님 지도하의  SMA Summer Project 2022에 선발된 '동시 출현 네트워크 분석 및 토픽 모델링을 활용한 국내 개발 취업 준비생과 현업자의 경험과 고충 분석: 온라인 커뮤니티 게시글을 중심으로’ 주제의 학부 연구를 수행 및 기록합니다.
...
---
## 분석 아이디어 추가 (22.07.12)
다빈도 분석으로 확인한 특정 키워드들이 등장한 게시글들의 본문 내용을 대상으로 감성분석하여 인사이트를 얻어보는 것은 어떨까?

<br><br>

ex) 'SI'(SI업체)가 등장한 게시글의 본문과 COMMENTS를 대상으로 감성분석을 수행하여, IT업계에서 사용되는 특정 키워드에 대한 인식의 온도를 객관적으로 알아보기.
